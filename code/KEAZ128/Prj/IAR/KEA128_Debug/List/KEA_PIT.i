...
void pit_init(PITn_e pitn, uint32 cnt)
{
    ...
    if (!(cnt > 0)) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Chip\\src\\KEA_PIT.c", 34);                            
...
void pit_delay(PITn_e pitn, uint32 cnt)
{
    ...
    if (!(cnt > 0)) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Chip\\src\\KEA_PIT.c", 69);                
