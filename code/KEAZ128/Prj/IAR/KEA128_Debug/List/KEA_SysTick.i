...
void systick_delay(uint32 time)
{
    ...
    if (!(time <= (0xFFFFFFu >> 0))) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Chip\\src\\KEA_SysTick.c", 155);  
...
void systick_timing(uint32 time)
{
    ...
    if (!(time <= (0xFFFFFFu >> 0))) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Chip\\src\\KEA_SysTick.c", 195);  
