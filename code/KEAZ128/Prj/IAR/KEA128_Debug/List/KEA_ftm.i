        ...
        case (uint32_t)((FTM_Type *)(0x4003A000u)):
            ...
            switch (ch)
            {
                case  FTM_CH0:
                    ...
                    if (PTF0 == PTC0) ((((SIM_Type *)(0x40048000u)))->PINSEL1) |= (((uint32_t)(((uint32_t)(0))<<0))&0x3u);
                    else if (PTF0 == PTF0) ((SIM_Type *)(0x40048000u))->PINSEL1 |= (((uint32_t)(((uint32_t)(2))<<0))&0x3u);
                    else if (PTF0 == PTH0) ((SIM_Type *)(0x40048000u))->PINSEL1 |= (((uint32_t)(((uint32_t)(1))<<0))&0x3u);

                    break;
                case  FTM_CH1:
                    ((((SIM_Type *)(0x40048000u)))->PINSEL1) &= ~0xCu;     
                    if (PTF1 == PTC1) ((((SIM_Type *)(0x40048000u)))->PINSEL1) |= (((uint32_t)(((uint32_t)(0))<<2))&0xCu);
                    else if (PTF1 == PTF1) ((SIM_Type *)(0x40048000u))->PINSEL1 |= (((uint32_t)(((uint32_t)(2))<<2))&0xCu);
                    else if (PTF1 == PTH1) ((SIM_Type *)(0x40048000u))->PINSEL1 |= (((uint32_t)(((uint32_t)(1))<<2))&0xCu);
                    break;
                case  FTM_CH2:
                    ((((SIM_Type *)(0x40048000u)))->PINSEL1) &= ~0x30u;     
                    if (PTD0 == PTC2) ((((SIM_Type *)(0x40048000u)))->PINSEL1) |= (((uint32_t)(((uint32_t)(0))<<4))&0x30u);
                    else if (PTD0 == PTD0) ((SIM_Type *)(0x40048000u))->PINSEL1 |= (((uint32_t)(((uint32_t)(1))<<4))&0x30u);
                    else if (PTD0 == PTG4) ((SIM_Type *)(0x40048000u))->PINSEL1 |= (((uint32_t)(((uint32_t)(2))<<4))&0x30u);
                    break;
                case  FTM_CH3:
                    ((((SIM_Type *)(0x40048000u)))->PINSEL1) &= ~0xC0u;     
                    if (PTD1 == PTC3) ((((SIM_Type *)(0x40048000u)))->PINSEL1) |= (((uint32_t)(((uint32_t)(0))<<6))&0xC0u);
                    else if (PTD1 == PTD1) ((SIM_Type *)(0x40048000u))->PINSEL1 |= (((uint32_t)(((uint32_t)(1))<<6))&0xC0u);
                    else if (PTD1 == PTG5) ((SIM_Type *)(0x40048000u))->PINSEL1 |= (((uint32_t)(((uint32_t)(2))<<6))&0xC0u);
                    break;
                case  FTM_CH4:
                    if (PTB4 == PTB4)
                    {
                    ...
                    break;
                case  FTM_CH5:
                    if (PTB4 == PTB5)        (((((SIM_Type *)(0x40048000u)))->PINSEL1)) &= ~(1<<(9));
                    else if (PTB4 == PTG7)   (((((SIM_Type *)(0x40048000u)))->PINSEL1)) |= (1<<(9));
                    break;
            }
...
void  ftm_pwm_finit(FTMn_e ftmn, FTM_CHn_e ch, uint32 freq, float duty)  
{
    ...
    if (!(ps <= 0x07)) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Chip\\src\\KEA_ftm.c", 183);                 
...
void ftm_pwm_init(FTMn_e ftmn, FTM_CHn_e ch, uint32 freq, uint32 duty)
{
    ...
    if (!(ps <= 0x07)) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Chip\\src\\KEA_ftm.c", 263);                 
...
void ftm_pwm_duty(FTMn_e ftmn, FTM_CHn_e ch, uint32 duty)
{
    ...
    switch ((uint32_t)ftmn)
    {
        ...
        case (uint32_t)((FTM_Type *)(0x40038000u)):
            if (!(duty <= 100u)) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Chip\\src\\KEA_ftm.c", 342);     
            break;

        case (uint32_t)((FTM_Type *)(0x40039000u)):
            if (!(duty <= 100u)) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Chip\\src\\KEA_ftm.c", 346);     
            break;
        case (uint32_t)((FTM_Type *)(0x4003A000u)):
            if (!(duty <= 100u)) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Chip\\src\\KEA_ftm.c", 349);     
            break;

        default:
            if (!(0)) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Chip\\src\\KEA_ftm.c", 353);
            break;
    }
    ...
    switch ((uint32_t)ftmn)
    {
        ...
        default:
            if (!(0)) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Chip\\src\\KEA_ftm.c", 401);
            break;
    }
...
void ftm_pwm_fduty(FTMn_e ftmn, FTM_CHn_e ch, float duty)
{
    ...
    if (!(duty <= 100.0)) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Chip\\src\\KEA_ftm.c", 425);     
    ...
    switch ((uint32_t)ftmn)
    {
        ...
        default:
            if (!(0)) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Chip\\src\\KEA_ftm.c", 456);
            break;
    }
...
void ftm_pwm_freq(FTMn_e ftmn, uint32 freq)             
{
    ...
    if (!(ps <= 0x07)) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Chip\\src\\KEA_ftm.c", 491);                 
    ...
    switch ((uint32_t)ftmn)
    {
        ...
        default:
            if (!(0)) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Chip\\src\\KEA_ftm.c", 510);
            break;
    }
...
{
    if (!((ftmn == ((FTM_Type *)(0x4003A000u))))) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Chip\\src\\KEA_ftm.c", 543);     
