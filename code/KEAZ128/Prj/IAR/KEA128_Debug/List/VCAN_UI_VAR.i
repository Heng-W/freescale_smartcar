...
void var_init()
{
    ...
    for (var_num = 0; var_num < VAR_MAX; var_num++)
    {
        ...
        if (!(num_info[var_num]. maxval >= num_info[var_num]. minval)) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Board\\src\\VCAN_UI_VAR.c", 61);
    }
}
...
{
    if (!(new_tab < VAR_MAX)) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Board\\src\\VCAN_UI_VAR.c", 113);
...
{
    if (!(new_tab < VAR_MAX)) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Board\\src\\VCAN_UI_VAR.c", 173);
...
void var_ok()
{
    if (!(new_tab < VAR_MAX)) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Board\\src\\VCAN_UI_VAR.c", 226);
...
void val_cancel()
{
    if (!(new_tab < VAR_MAX)) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Board\\src\\VCAN_UI_VAR.c", 240);
...
void var_display(uint8 tab)
{
    ...
    if (!((new_tab < VAR_MAX) && (tab <= VAR_MAX))) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Board\\src\\VCAN_UI_VAR.c", 272);
...
{
    if (!((new_tab < VAR_MAX) && (tab <= VAR_MAX))) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Board\\src\\VCAN_UI_VAR.c", 334);
...
{
    uint8 ret;
    if (!(mode < CAR_CTRL_MAX)) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Board\\src\\VCAN_UI_VAR.c", 383);
