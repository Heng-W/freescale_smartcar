...
void InitMPU6050(void)
{
    simiic_write_reg(0xD0>>1, 0x6B, 0x00);      
    simiic_write_reg(0xD0>>1, 0x19, 0x07);      
    simiic_write_reg(0xD0>>1, 0x1A, 0x04);          
    simiic_write_reg(0xD0>>1, 0x1B, 0x18);     
    simiic_write_reg(0xD0>>1, 0x1C, 0x10);    
    simiic_write_reg(0xD0>>1, 0x6A, 0x00);
    simiic_write_reg(0xD0>>1, 0x37, 0x02);
}
...
void Get_AccData(void)
{
    ...
    simiic_read_regs(0xD0>>1, 0x3B, dat, 6, IIC);
...
void Get_Gyro(void)
{
    ...
    simiic_read_regs(0xD0>>1, 0x43, dat, 6, IIC);
