...
extern float voltage_gyro ;                                                 
extern float voltage_gravity ;                                              
...
void MotorSpeedOut(void)     
{
    ...
    if (fLeftVal > 0)  fLeftVal += 9;
    else if (fLeftVal < 0)  fLeftVal -= 9;

    if (fRightVal > 0)  fRightVal += 3;
    else if (fRightVal < 0)  fRightVal -= 3;
...
void SetMotorVoltage(float fLeftVoltage, float fRightVoltage) 
{
    ...
    if (fLeftVoltage > 0)
    {
        ftm_pwm_fduty(((FTM_Type *)(0x4003A000u)), FTM_CH3, 0);
        nOut = fLeftVoltage ;
        ftm_pwm_fduty(((FTM_Type *)(0x4003A000u)), FTM_CH2, nOut);
    }
    else
    {
        ftm_pwm_fduty(((FTM_Type *)(0x4003A000u)), FTM_CH2, 0);
        fLeftVoltage = -fLeftVoltage;
        nOut = fLeftVoltage ;
        ftm_pwm_fduty(((FTM_Type *)(0x4003A000u)), FTM_CH3, nOut);
    }

    if (fRightVoltage > 0)
    {
        ftm_pwm_fduty(((FTM_Type *)(0x4003A000u)), FTM_CH5, 0);
        nOut = fRightVoltage ;
        ftm_pwm_fduty(((FTM_Type *)(0x4003A000u)), FTM_CH4, nOut);
    }
    else
    {
        ftm_pwm_fduty(((FTM_Type *)(0x4003A000u)), FTM_CH4, 0);
        fRightVoltage = -fRightVoltage;
        nOut = fRightVoltage ;
        ftm_pwm_fduty(((FTM_Type *)(0x4003A000u)), FTM_CH5, nOut);
    }
...
void PWM_Init(void)
{
    ftm_pwm_finit(((FTM_Type *)(0x4003A000u)), FTM_CH2, 10000, 0);
    ftm_pwm_finit(((FTM_Type *)(0x4003A000u)), FTM_CH3, 10000, 0);
    ftm_pwm_finit(((FTM_Type *)(0x4003A000u)), FTM_CH4, 10000, 0);
    ftm_pwm_finit(((FTM_Type *)(0x4003A000u)), FTM_CH5, 10000, 0);
