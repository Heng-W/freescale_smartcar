...
void sensor_get(void)
{
    AD_Get[0] = adc_once(ADC0_SE0, ADC_8bit);
    AD_Get[1] = adc_once(ADC0_SE1, ADC_8bit);
    AD_Get[2] = adc_once(ADC0_SE8, ADC_8bit);
    AD_Get[3] = adc_once(ADC0_SE9, ADC_8bit);
    AD_Get[4] = adc_once(ADC0_SE10, ADC_8bit);
    AD_Get[5] = adc_once(ADC0_SE11, ADC_8bit);
}
