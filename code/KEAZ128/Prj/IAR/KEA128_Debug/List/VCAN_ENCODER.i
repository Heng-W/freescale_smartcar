...
void Encoder_Init(void)
{
    ...
    ftm_pulse_init(((FTM_Type *)(0x4003A000u)), FTM_PS_1, PTA5);   
    gpio_init(PTC5, GPI, 0);  
    port_pull(PTC5, 1);         

    ftm_pulse_init(((FTM_Type *)(0x4003A000u)), FTM_PS_1, PTE0);   
    gpio_init(PTH5, GPI, 0);  
    port_pull(PTH5, 1);         
}
...
{
    uint16 temp1, temp2;       
    temp1 = ftm_pulse_get(((FTM_Type *)(0x40038000u))) ; 
    temp2 = ftm_pulse_get(((FTM_Type *)(0x40039000u)));
    
    ftm_clean(((FTM_Type *)(0x40038000u))) ;
    ftm_clean(((FTM_Type *)(0x40039000u))) ;
    
    if (gpio_get(PTC5))    speedl = -((int16)(temp1)); 
    else                speedl = temp1;
    if (gpio_get(PTH5))    speedr = -((int16)(temp2)); 
    else                speedr = temp2;
