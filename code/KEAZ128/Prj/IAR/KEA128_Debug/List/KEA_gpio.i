...
{
    if (!((((((GPIOX[((ptxn)>>5)])->PDDR))>>(((ptxn)&0x1f)))&0x01) == GPO)) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Chip\\src\\KEA_gpio.c", 100);     
...
{
    if (!((((((GPIOX[((ptxn)>>5)])->PDDR))>>(((ptxn)&0x1f)))&0x01) == GPO)) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Chip\\src\\KEA_gpio.c", 124);     
...
{
    if (!((((((GPIOX[((ptxn)>>5)])->PDDR))>>(((ptxn)&0x1f)))&0x01) == GPI)) assert_failed("E:\\resources\\smart_car\\prj\\code\\KEAZ128\\Chip\\src\\KEA_gpio.c", 141);     
