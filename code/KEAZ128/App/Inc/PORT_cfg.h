...
#define FTM1_CH1_PIN    PTC5       //PTC5、PTE7

//      模块通道    端口          可选范围              建议
#define FTM2_CH0_PIN    PTF0       //PTC0、PTF0、PTH0
#define FTM2_CH1_PIN    PTF1       //PTC1、PTF1、PTH1
#define FTM2_CH2_PIN    PTD0       //PTC2、PTD0、PTG4
#define FTM2_CH3_PIN    PTD1       //PTC3、PTD1、PTG5
...
#define FTM0_PULSE_PIN   TCLK1        //从 TCLKn里任意选其中一个
#define FTM1_PULSE_PIN   TCLK2        //从 TCLKn里任意选其中一个
#define FTM2_PULSE_PIN   TCLK0       //从 TCLKn里任意选其中一个
